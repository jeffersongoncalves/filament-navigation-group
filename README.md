...
![Filament Navigation Group](https://raw.githubusercontent.com/jeffersongoncalves/filament-navigation-group/1.x/art/jeffersongoncalves-filament-navigation-group.png)
...
[![GitHub Tests Action Status](https://img.shields.io/github/actions/workflow/status/jeffersongoncalves/filament-navigation-group/tests.yml?branch=1.x&label=tests&style=flat-square)](https://github.com/jeffersongoncalves/filament-navigation-group/actions?query=workflow%3ATests+branch%3A1.x)
[![GitHub Code Style Action Status](https://img.shields.io/github/actions/workflow/status/jeffersongoncalves/filament-navigation-group/pint.yml?branch=1.x&label=code%20style&style=flat-square)](https://github.com/jeffersongoncalves/filament-navigation-group/actions?query=workflow%3A"Fix+PHP+code+styling"+branch%3A1.x)
...
```bash
composer require jeffersongoncalves/filament-navigation-group:"^1.0"
```
